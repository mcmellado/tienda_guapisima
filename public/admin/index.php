...
<body>
    ...
    $sent = $pdo->query("SELECT p.*, c.categoria, c.id as id_categoria
                    FROM articulos p
...
<div class="container mx-auto">
    ...
    <div class="container mx-auto">
    <a href="/admin/insertar.php"><button class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900">Insertar nuevo articulo</button></a>
    <a href="/admin/categoria.php"><button class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900">Insertar nueva categoría</button></a>
    <a href="/admin/borrar_categoria.php"><button class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900">Borrar categoría</button></a>
    <a href="/admin/insertar_cupon.php"><button class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-blue-900">Insertar cupon</button></a>
    <a href="/admin/borrar_cupon.php"><button class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 mr-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Borrar cupon</button></a>
        ...
        <div class="overflow-x-auto relative mt-4">
            <table class="mx-auto text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    ...
                    <th scope="col" class="py-3 px-6 text-center">Categoria</th>
                    <th scope="col" class="py-3 px-6 text-center">Descuento</th>
                ...
                <tbody>
                    <?php foreach ($sent as $fila) : ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="py-4 px-6"><?= hh($fila['fecha']) ?></td>
                            <td class="py-4 px-6"><?= hh($fila['categoria']) ?></td>
                        <?php if(hh($fila['descuento']) != null): ?> 
                            <td class="py-4 px-6"><?= hh($fila['descuento']) ?> % </td>
                        <?php else: ?>
                            <td class="py-4 px-6">Sin descuento</td>
                        <?php endif ?>
                            ...
                            <td class="px-6 text-center">
                                ...
                                <a href="/admin/descuentos.php?id=<?= $fila_id ?>"><button class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900">Aplicar descuento</button></a>
                                <form action="/admin/visible.php" method="POST" class="inline">
                                    <input type="hidden" name="id" value="<?= $fila_id ?>">
                                    <?php if ($fila['visible']): ?>
